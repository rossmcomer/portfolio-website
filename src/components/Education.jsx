...
const Education = () => {
  const certificates = [
    {
      description:
        'Certificate in Full Stack Development from University of Helsinki',
    ...
    {
      description:
        'Certificate in Relational Database Development from freeCodeCamp.org',
                ...
                <Table size="small" aria-label="details">
                  <TableBody>
                    <TableRow sx={{ borderBottom: 'none' }}>
                      <TableCell>
                        {row.link ? (
                          <Link href={row.link} underline="none" id="certLink">
                            View Certificate
                          </Link>
                        ) : (
                          'N/A'
                      ...
                      <TableCell align="right" id="certDate">
                        {row.date}
                      </TableCell>
                    </TableRow>
                  </TableBody>
      ...
      <div className="certificationsTable">
        <TableContainer component={Paper}>
          <Table>
            <TableHead>
              <TableRow>
                <StyledTableCell align="center" colSpan={5} id="certTitle">
